...
export const CalculatorScreen = () => {
    ...
    const {number, buildNumber ,prevNumber,formula, toggleSign ,clean, deleteOperation ,divideOperation, multiplyOperation, subtrackOperation, addOperation, calculateResult} = useCalculator();
  ...
  return (
    <View style={styles.calculatorContainer}>
        ...
        <View style={styles.row}>
            ...
            <CalculatorButton onPress={ subtrackOperation} label="-" color={colors.orange}/>
        </View>
        <View style={styles.row}>
